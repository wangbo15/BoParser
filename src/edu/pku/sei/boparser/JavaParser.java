...
public class JavaParser implements JavaParserConstants {
	...
	public static void main(String args[]) {
		...
		// String path =
		// "/home/nightwish/workspace/eclipse/FaultPrediction/src/edu/pku/sei/faultpre/test/Test.java";;
		// String path =
		// "/home/nightwish/workspace/fault_prediction/subjects/jakarta-ant-1.5/src/main/org/apache/tools/tar/TarUtils.java";
	...
	/*
	 * The third LOOKAHEAD specification below is to parse to PrimarySuffix if there
	 * is an expression between the "[...]".
	 */
	...
	final public void RUNSIGNEDSHIFT() throws ParseException {
		if (getToken(1).kind == GT && ((MyToken) getToken(1)).realKind == RUNSIGNEDSHIFT) {
	...
	final public void RSIGNEDSHIFT() throws ParseException {
		if (getToken(1).kind == GT && ((MyToken) getToken(1)).realKind == RSIGNEDSHIFT) {
	...
	private boolean jj_3R_73() {
		...
		jj_semLA = getToken(1).kind == GT && ((MyToken) getToken(1)).realKind == RSIGNEDSHIFT;
	...
	private boolean jj_3R_74() {
		jj_lookingAhead = true;
		jj_semLA = getToken(1).kind == GT && ((MyToken) getToken(1)).realKind == RUNSIGNEDSHIFT;
		jj_lookingAhead = false;
