...
public class JavaParser implements JavaParserConstants {
  ...
  public static void main(String args[]) {
      ...
      //String path = "/home/nightwish/workspace/eclipse/FaultPrediction/src/edu/pku/sei/faultpre/test/Test.java";;
      //String path = "/home/nightwish/workspace/fault_prediction/subjects/jakarta-ant-1.5/src/main/org/apache/tools/tar/TarUtils.java";
      String path = "/home/nightwish/workspace/eclipse/FaultPrediction/resorce/1.5/JavaGenerics.java";

      System.out.println("Java Parser Version 1.1:  Reading from file " + path + " . . .");
      try {
        parser = new JavaParser(new java.io.FileInputStream(path));
      } catch (java.io.FileNotFoundException e) {
        System.out.println("Java Parser Version 1.1:  File " + path + " not found.");
        return;
      }
      ...
      for(Token t : allTokens){
        System.out.println(t.image + ": " + t.beginLine + "-" + t.endLine);
      }
  }
  	 ...
  	 * @return
  	 */
	public static String lexer(File file) {
		JavaParser parser;
		allTokens.clear();
		try {
			parser = new JavaParser(new java.io.FileInputStream(file));
		} catch (java.io.FileNotFoundException e) {
			System.err.println("Java Parser Version 1.1:  File " + file.getAbsolutePath() + " not found.");
			return null;
		}

		try {
			parser.CompilationUnit();
			// System.out.println("Java Parser Version 1.1: Java program parsed
			// successfully.");
		} catch (ParseException e) {
			System.err.println(e.getMessage());
			System.err.println("Java Parser Version 1.1:  Encountered errors during parse.");
			System.err.println(file.getAbsolutePath());
		}
		StringBuffer sb = new StringBuffer(file.getName() + "\n");
		for (int i = 0; i < allTokens.size() - 1; i++) {
			Token token = JavaParser.allTokens.get(i);
			
			if(isOperator(token.image) == false) {
				sb.append(token.image);
			}

			Token next = JavaParser.allTokens.get(i + 1);
			if (next.beginLine == token.beginLine) {
				sb.append(' ');
			} else {
				sb.append('\n');
			}
 ...
 */
  final public 
int Modifiers() throws ParseException {int modifiers = 0;
    label_3:
    while (true) {
      if (jj_2_2(2)) {
        ;
 ...
 */
  final public void TypeDeclaration() throws ParseException {int modifiers;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case SEMICOLON:{
      jj_consume_token(SEMICOLON);
      break;
  ...
  final public void ClassOrInterfaceDeclaration(int modifiers) throws ParseException {boolean isInterface = false;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case CLASS:{
...
isInterface = true;
  ...
  final public void ExtendsList(boolean isInterface) throws ParseException {boolean extendsMoreThanOne = false;
...
if (isInterface)
  ...
  final public void ClassOrInterfaceBodyDeclaration(boolean isInterface) throws ParseException {boolean isNestedInterface = false;
   int modifiers;
    if (jj_2_6(2)) {
      Initializer();
if (isInterface)
...
/* Annotation Types. */
  final public 
void AnnotationTypeDeclaration(int modifiers) throws ParseException {
    jj_consume_token(AT);
    jj_consume_token(INTERFACE);
    jj_consume_token(IDENTIFIER);
    AnnotationTypeBody();
  ...
  final public void AnnotationTypeMemberDeclaration() throws ParseException {int modifiers;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case ABSTRACT:
    case BOOLEAN:
    case BYTE:
